...
import mainapp.tasks as mainapp_tasks
...
class TestNewsSelenium(StaticLiveServerTestCase):
    ...
    def setUp(self):
        ...
        button_enter = WebDriverWait(self.selenium, 5).until(EC.visibility_of_element_located((By.CSS_SELECTOR, '[type="submit"]')))
    ...
    def test_create_button_clickable(self):
        ...
        button_create = WebDriverWait(self.selenium, 5).until(EC.visibility_of_element_located((By.CSS_SELECTOR, f'[href="{path_add}"]')))
