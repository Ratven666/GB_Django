...
def forwards_func(apps, schema_editor):
    ...
    News.objects.create(title="Запуск нового курса по Python",
                        ...
                        body="Python предназначен для разработки и изучения новых приложений. \
                                ...
                                тем, у кого нет возможности посещать курсы.Курс состоит из 7 встреч — \
                                одно занятие в неделю длительностью 3 часа.\r\nВстречи \
                                проводятся по воскресеньям с 14: 00. ",
                        )
    News.objects.create(title="Урока по PHP в среду не состоится",
    ...
    News.objects.create(
        ...
        body="Каждый из 5 руководителей будет в одном из своих офисов с \
                ...
                всё, что происходит на сайте, просматривать отчёты, которые им \
